                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-slate-700">
                  ...
                  <blockquote className="relative p-8 mb-4">
                    <svg
                      ...
                      <polygon points="-30,95 583,95 583,65" className="text-slate-700 fill-current"></polygon>
                    </svg>
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-slate-400 uppercase font-semibold">Web Developer</p>
                    <div className="mt-6">
                      <button
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-slate-400 uppercase font-semibold">Marketing Specialist</p>
                    <div className="mt-6">
                      <button
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-slate-400 uppercase font-semibold">UI/UX Designer</p>
                    <div className="mt-6">
                      <button
                        className="bg-red-600 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button">
              ...
              <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <p className="mt-1 text-sm text-slate-400 uppercase font-semibold">Founder and CEO</p>
                    <div className="mt-6">
                      <button
                        className="bg-pink-500 text-white w-8 h-8 rounded-full outline-none focus:outline-none mr-1 mb-1"
                        type="button">
              ...
              <div className="w-full lg:w-6/12 px-4">
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-slate-200">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3">
                      <label className="block uppercase text-slate-600 text-xs font-bold mb-2" htmlFor="message">
                        Message
                      </label>
                      <textarea
                        rows={4}
